---
title: 'Condensed — Unite Fate Edition'
breadcrumbs: false
...
Это *Fate Condensed — Unite Fate Edition* — версия *Fate Core System* в настолько компактной форме, насколько нам удалось. Это полноценная ролевая игра; хотя другие книги и могут привнести новые идеи, для игры вам не нужны никакие другие книги.

На этой ноте перейдем к тому, что вам действительно нужно!

### Что мне понадобится для игры?

Для игры вам понадобится от двух до шести друзей, один из которых выступает в качестве Ведущего (ГМ, Мастер), несколько кубиков, несколько жетонов, письменные принадлежности, бумага и что-то для написания коротких заметок (например, маленькие «липкие записки» стикеры).

Когда персонажи совершают те или иные действия, мы используем кубики **Fate**™. 

Это шестигранные кубики с двумя **[0]** гранями, двумя **[+]** гранями и двумя **[-]** гранями. Один набор из четырех кубиков будет работать хорошо, но один набор на игрока — идеальный вариант. Существуют и другие альтернативы, например, использование стандартных шестигранных кубиков (1-2 = **[-]**, 3-4 = **[0]**, 5-6 = **[+]**) или **Колода Fate**, в которой вместо кубиков используются карты. Мы используем слово «бросок» на протяжении всего текста для простоты.

#### Для ветеранов: отличия от Fate Core, Accelerated и Condensed
...
В **Fate** все рейтинги организованы в лестницу прилагательных, показанную здесь.
